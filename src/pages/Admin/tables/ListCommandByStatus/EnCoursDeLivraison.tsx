...
const Annulee = () => {
  ...
  const [valueOfTheCommandeStatus, setValueOfTheCommandeStatus] = useState<string[]>(['en préparation','en attente pickup','en dépot','en cours de livraison','livré','reporté','annulé']);
          ...
          <div className="col-12">
            ...
            <div className="card">
              <div className="card-header">
                <h3 className="card-title">Commandes En Cours De Livraison</h3>
              </div>
              {/* /.card-header */}
